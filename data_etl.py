...
# PIL
pil_df = get.get_data("163_156_DF_DCCN_SQCQ_3", dimensions=["Q","IT","","L_2020","N",""])
# Crescita PIL
pil_growth_df = get.get_data("163_156_DF_DCCN_SQCQ_2", dimensions=["Q","IT","B1GQ_B_W2_S1","GO1", "Y",""])
# Disoccupazione
unemployment_df = get.get_data("151_874_DF_DCCV_TAXDISOCCUMENS1_1", dimensions=["","","","N","9","Y15-74",""])
# Inflazione
...
# conn.execute("DELETE FROM Dati WHERE idData > 20250430")

# conn.execute("DELETE FROM ImmDati WHERE idData > 20250430")
